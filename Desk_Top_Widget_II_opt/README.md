# Desktop Widget II - Optimierte Version
...
Die Konfiguration ist sehr einfach! Öffne `Desk_Top_Widget_II_opt.ino` und ändere nur die Airport-Codes im Konfigurations-Bereich:
...
1. Öffne `Desk_Top_Widget_II_opt.ino` in der Arduino IDE
